...
const files = [
  ...
  ...(fs.existsSync(path.join(ROOT, "imoveis")) ? fs.readdirSync(path.join(ROOT, "imoveis"), { withFileTypes: true }).filter(e => e.isDirectory()).map(e => path.join(ROOT, "imoveis", e.name, "index.html")) : [])
];
